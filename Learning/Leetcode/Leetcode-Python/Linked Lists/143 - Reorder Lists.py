...
# Roep de reorderList-functie aan
oplossing.reorderList(gelinkte_lijst)

# Print de opnieuw gerangschikte gelinkte lijst
huidige = gelinkte_lijst
while huidige:
    print(huidige.val, end=" -> ")
